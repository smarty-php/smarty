        ...
        if (isset($_attr[ 'assign' ])) {
            ...
            if (!$_attr[ 'nofilter' ]) {
                ...
                if ($compiler->template->smarty->escape_html) {
                    $doubleEscape = $compiler->template->smarty->escape_html_double_encode ? ', false' : '';
                    $output = "htmlspecialchars({$output}, ENT_QUOTES, '" . addslashes(Smarty::$_CHARSET) . "'$doubleEscape)";
                }
