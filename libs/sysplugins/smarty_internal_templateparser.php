...
#line 1732 "smarty_internal_templateparser.php"
...
#line 776 "smarty_internal_templateparser.y"
    function yy_r120(){
    self::$prefix_number++;
    $this->compiler->prefix_code[] = '<?php ob_start();?>'.$this->yystack[$this->yyidx + 0]->minor.'<?php $_tmp'.self::$prefix_number.'=ob_get_clean();?>';
