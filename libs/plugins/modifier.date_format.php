...
function smarty_modifier_date_format($string, $format = null, $default_date = '', $formatter = 'auto')
{
    ...
    if ($formatter === 'strftime' || ($formatter === 'auto' && strpos($format, '%') !== false)) {
        ...
        if (version_compare(PHP_VERSION, '8.1', '>=')) {
            return php8strftime($format, $timestamp);
        }
 ...
 * Usage:
 * use func php8strftime;
 * echo php8strftime('%A %e %B %Y %X', new \DateTime('2021-09-28 00:00:00'), 'fr_FR');
 * Original use:
 * \setlocale('fr_FR.UTF-8', LC_TIME);
 * echo \php8strftime('%A %e %B %Y %X', strtotime('2021-09-28 00:00:00'));
 *
 ...
 */
function php8strftime(string $format, $timestamp = null): string
{
